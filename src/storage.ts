...
// Keep the pre-rename storage namespace so existing browser-local work remains available.
...
/**
 * Clears only application-owned browser state. The empty dataset keeps a monotonically
