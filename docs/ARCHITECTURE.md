...
naruto-gesture-detection is a static browser application. Webcam capture, feature extraction, model training, persistence, inference, and rendering all happen client-side.
